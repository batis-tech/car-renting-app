...
jQuery(document).ready(function($){
	...
	for ( make in cars )
	{
		$('#carmakes_cont').append('<option value="'+make+'">'+make+'</option>');
	}

	$('#carmakes_cont').change(function(){
		var val = $(this).val();
		$('#carmodels_cont').html('<option value="">Select Model</option>');
		for ( i in cars[val] )
		{
			$('#carmodels_cont').append('<option value="'+cars[val][i]+'">'+cars[val][i]+'</option>');
		}
		$('#carmodels_cont').append('<option value="Other">- Other -</option>');
	});

	$('#carmakes_cont, span.text select').each(function(){
